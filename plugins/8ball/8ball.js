...
module.exports = {
  ...
  description: "PING",
  author: "Made by EarWaxCandy. updated by Rehkloos, Bioblaze & Krammy. Cleaned Responses by Praxem",
  license: "Apache-2.0",
  ...
  execute(client, data) {
     var answer = sResponses[Math.floor( Math.random() * (sResponses.length - 1) )];
