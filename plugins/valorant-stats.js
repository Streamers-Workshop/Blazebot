        ...
        .get(userUrl, (resp) => {
          ...
          resp.on('end', () => {
            ...
            if (obj.data) {
              ...
              bot.sendMessage(
                `@${user} here is your  Valorant stats\r Current Rank: ${rank}\rK/D Ratio: ${kdr}% \r Win Ratio: ${winr}\r Total Wins: ${wins}\r Total Kills: ${kills}\r Total Deaths: ${deaths}\r Most Kills: ${mKills}`,
              );
            } else {
