...
module.exports = {
  ...
  execute(client, data) {
            ...
            && settings.alerts.spell.active)
    {
      ...
      var scene = settings.alerts.spell.scene;
      var source = settings.alerts.spell.source;
      var delay = settings.alerts.spell.delay;
      var message = settings.alerts.spell.message;
      var template = Handlebars.compile(message);
      client.sendMessage(template({
        user: data.user,
      }));
