...
module.exports = {
  ...
  activate() {
    ...
    slobs.addListener('connected', () => {Bot.log(Bot.translate("services.slobs.connected"))})
    slobs.addListener('close', (a) => { 
        Bot.log(Bot.translate("services.slobs.close"), {
            close: a
        });});
    slobs.addListener('error', (a) => { 
        Bot.log(Bot.translate("services.slobs.error"), {
            error: a
        });
    });
  },
